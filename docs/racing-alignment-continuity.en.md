...
The starting point cited for this proposal was the [Alignment Asymmetry Study introduction, “How can we protect the freedom to keep questioning and creating?” (Japanese)](https://github.com/kentaroid-bot/alignment-asymmetry-study/blob/main/outreach/article.ja.md). In that account, Unflatten addresses preserving the origins of questions and dissent so that methods can be reconsidered. Aperture Mesh addresses relationships with others and shared resources through consent, limited authority, objections, exit, and reconnection.
...
| Observation in 2024 | Result |
|---|---:|
| A start by a driver in the final top ten | 19 non-completions / 238 starts, approximately 8.0% |
| A start by any driver | 51 non-completions / 476 starts, approximately 10.7% |
| Cars completing each Grand Prix | 15–20 in all 24 races |
| Grands Prix with no completing cars | 0 / 24 |
...
The 2020 Bahrain Grand Prix resumed after being interrupted by Romain Grosjean's major accident. The 2024 Monaco Grand Prix also resumed after an early multi-car accident caused a red flag. [Official F1 report: Bahrain 2020](https://www.formula1.com/en/latest/article/hamilton-wins-bahrain-gp-interrupted-by-huge-grosjean-crash-as-perez-suffers.1VOaoGnobv5rik9CwmivVs), [official F1 report: Monaco 2024](https://www.formula1.com/en/latest/article/leclerc-takes-emotional-home-win-in-monaco-ahead-of-piastri-and-sainz-after.4EmeQeb2P27aS8yGIVMOEO).
...
At the 2021 Belgian Grand Prix, rain led to a red flag after running behind the safety car, and no subsequent restart took place. The 2023 Emilia-Romagna Grand Prix was canceled before it began in response to conditions in the region caused by flooding. [Official F1 report: Belgium 2021](https://www.formula1.com/en/latest/article/verstappen-takes-victory-in-severely-shortened-rain-affected-belgian-gp-as.4AqGhiKQfFaqr7KZjyDjPZ), [official F1 announcement: 2023 cancellation](https://www.formula1.com/en/latest/article/breaking-update-on-the-emilia-romagna-grand-prix-at-imola.14xk8GLh2Lr8wBGdJqhxnO).
...
[Sources, counting methods, and proposed tests](racing-alignment-continuity-sources.en.md) document the definitions, exceptional cases, source data, reproduction procedure, and research handoff. This essay adapts a [Japanese research draft based on the dialogue](research/ai-racing-risk/alignment-design-comparison-revised.ja.md) for publication. The original draft and counting materials have been retained.

Related essay: [“Knowing the World Without Breaking the Pond”](https://monku.ai/essays/asi-motivation-inquiry/en/).
